...
export default function PredictiveMapPage() {
    return (
        <div className="min-h-screen bg-background text-foreground pb-24 font-sans px-6 pt-10" suppressHydrationWarning>
            {/* TopHeader */}
            ...
            <section className="mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-sm font-bold text-slate-500 italic">Distribución de Maestría</h2>
                    <span className="text-[10px] text-slate-400 font-bold">Hoy vs. Histórico</span>
                </div>
                <div className="bg-card p-5 rounded-2xl border border-border shadow-sm">
                    {/* Heatmap Grid */}
                    <div className="grid grid-cols-7 gap-1.5 mb-4">
                        {/* Labels */}
                        <div className="col-span-7 flex justify-between text-[8px] text-slate-400 uppercase tracking-widest mb-2 px-1 font-bold">
                        ...
                        <div className="col-span-7 flex items-center gap-2 mb-1">
                            <span className="w-20 text-[9px] text-slate-500 font-bold truncate uppercase tracking-tighter">P. Crítico</span>
                        ...
                        <div className="col-span-7 flex items-center gap-2 mb-1">
                            <span className="w-20 text-[9px] text-slate-500 font-bold truncate uppercase tracking-tighter">Raz. Cuant.</span>
                            <div className="flex-1 grid grid-cols-12 gap-1">
                                {[...Array(12)].map((_, i) => (
                        ...
                        <div className="col-span-7 flex items-center gap-2">
                            <span className="w-20 text-[9px] text-slate-500 font-bold truncate uppercase tracking-tighter">Anál. Datos</span>
                            <div className="flex-1 grid grid-cols-12 gap-1">
                                {[...Array(12)].map((_, i) => (
            ...
            <section className="mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
                <div className="relative overflow-hidden bg-slate-900 dark:bg-[#1A2B3C] text-white p-7 rounded-3xl shadow-xl">
            ...
            <section className="mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500">
                <h3 className="text-[10px] tracking-[0.15em] uppercase text-slate-500 font-bold mb-4 px-2">Ruta Proyectada al Éxito</h3>
                <div className="bg-card p-6 rounded-2xl h-64 relative overflow-hidden border border-border shadow-sm">
                    ...
                    <div className="absolute bottom-4 right-6 text-right z-10">
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Confianza del Algoritmo</p>
                        <p className="text-xl font-black text-slate-800 dark:text-foreground">94.8%</p>
                    </div>
                </div>
            </section>
            ...
            <section className="mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-700">
                <div className="flex items-start gap-4 p-5 bg-card rounded-2xl border border-border shadow-sm transition-all duration-500 ease-in-out hover:scale-[1.01]">
                    ...
                    <div>
                        <h4 className="text-[11px] uppercase tracking-widest text-teal-600 font-black mb-1">Momento Óptimo</h4>
                        <p className="text-xs text-slate-500 font-medium leading-relaxed">
                            Basado en tu mapa de calor, tu mejor momento para aprender es entre las <span className="font-bold text-slate-900 dark:text-foreground">10:00 AM y 12:00 PM</span>.
                        </p>
                    </div>
                </div>
            </section>
