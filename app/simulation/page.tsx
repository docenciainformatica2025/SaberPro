...
import { ArrowLeft, Brain, Sparkles, Zap, Timer, Clock, HelpCircle, ShieldAlert, Crown } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-[var(--theme-bg-base)] p-6 md:p-12 pb-32">
            <div className="max-w-7xl mx-auto animate-in fade-in duration-700">
                ...
                {/* High-Impact Growth Modal */}
                {showPremiumModal && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-[var(--theme-bg-base)]/80 backdrop-blur-2xl animate-in fade-in duration-300">
                        <Card variant="primary" className="max-w-md w-full p-12 text-center space-y-8 shadow-4k animate-in zoom-in-95 duration-300 relative border-brand-primary/20 overflow-hidden">
                            ...
                            <div className="space-y-3">
                                <h3 className="text-3xl font-black text-[var(--theme-text-primary)] uppercase italic leading-none tracking-tighter">
                                    Simulación <span className="text-brand-primary">Sin Límites</span>
                                </h3>
                                <p className="text-[10px] font-black text-brand-primary uppercase tracking-[0.3em] opacity-80">Rendimiento Nivel Élite</p>
                                <p className="text-sm text-[var(--theme-text-secondary)] font-medium leading-relaxed mt-4">
                                    Has agotado tus intentos gratuitos. Los usuarios <span className="text-brand-primary font-bold">PRO</span> realizan simulacros ilimitados, acceden a la experiencia real de 4.5 horas y desbloquean todas las competencias.
                                </p>
                            </div>
                            ...
                            <div className="space-y-4 pt-4">
                                ...
                                >
                                    <Zap size={16} fill="currentColor" /> Obtener Acceso Ilimitado
                                </Button>
                                <Button 
                                    variant="ghost" 
                            ...
                            <div className="pt-4 flex items-center justify-center gap-4 border-t border-[var(--theme-border-soft)]">
                                ...
                                <span className="text-[9px] font-bold text-[var(--theme-text-tertiary)] uppercase tracking-widest">Asegura tu beca con SaberPro ELITE</span>
                            </div>
                        </Card>
                    </div>
                )}
