...
export const StepCard: React.FC<StepCardProps> = ({
    ...
    return (
        <div className={cn("relative z-10 flex flex-col items-center text-center group", className)} role="listitem">
            <div className={cn(
                "w-28 h-28 rounded-[2rem] bg-[var(--theme-bg-surface)] border flex items-center justify-center text-4xl font-bold transition-all duration-500 group-hover:scale-105 group-hover:shadow-md mb-8 shadow-sm",
                isPrimary
