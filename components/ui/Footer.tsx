            ...
            <div suppressHydrationWarning className="container mx-auto px-6">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex gap-6 mt-4 opacity-50 hover:opacity-100 transition-opacity duration-300">
                        <a href="mailto:contacto@saberpro.app" className="text-metal-silver hover:text-white text-[10px] uppercase tracking-widest font-bold flex items-center gap-2">
                            ✉️ Contacto
                        </a>
