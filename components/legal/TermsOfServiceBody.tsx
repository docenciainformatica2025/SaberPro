...
export default function TermsOfServiceBody() {
    return (
        <div className="space-y-10 text-metal-silver text-justify">
            ...
            <div className="bg-gradient-to-r from-metal-gold/20 to-black p-6 rounded-xl border border-metal-gold/20 flex flex-col md:flex-row justify-between gap-4">
                <div>
                    <h3 className="text-metal-gold font-bold mb-2 uppercase tracking-widest text-sm">TÉRMINOS Y CONDICIONES DE USO</h3>
                    <p className="text-xs text-metal-gold/60">Regula la relación contractual y el descargo de responsabilidad.</p>
                </div>
            ...
            <section className="space-y-4">
                <h2 className="text-lg md:text-xl font-bold text-white flex items-center gap-3">
                    <MousePointerClick className="text-metal-gold" />
            ...
            <section className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    <div className="p-5 bg-black/40 border border-white/5 rounded-xl hover:border-metal-gold/30 transition-colors">
            ...
            <section className="space-y-4">
                <h2 className="text-lg md:text-xl font-bold text-white flex items-center gap-3">
                    <Shield className="text-metal-gold" />
                    3. EXENCIÓN DE RESPONSABILIDAD
                </h2>
                ...
                <div className="space-y-3">
                    <div className="flex gap-3">
                        <div className="mt-1 min-w-[4px] h-4 bg-red-500/50 rounded-full"></div>
                        <div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs mt-1">El Ing. Antonio Rodríguez no se hace responsable por los resultados obtenidos por el Usuario en las pruebas reales. El éxito depende exclusivamente de la preparación individual del estudiante.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="space-y-4">
                ...
                <p className="leading-relaxed text-sm">
                    El código fuente, diseño, algoritmos y base de datos son propiedad exclusiva del Ing. Antonio Rodríguez (Copyright © 2024-2025).
            ...
            <section className="space-y-6 opacity-80 hover:opacity-100 transition-opacity">
                <h2 className="text-lg md:text-xl font-bold text-white flex items-center gap-3">
                    <Scale className="text-metal-gold" />
                    5. CLÁUSULAS INTERNACIONALES (SaaS Estándar)
                </h2>

                <div className="grid md:grid-cols-3 gap-4">
                    <div className="p-4 rounded-lg bg-metal-gold/5 border border-white/5 hover:border-metal-gold/30 transition-all">
                        <h4 className="text-white font-bold flex items-center gap-2 text-xs mb-2">
                            <RefreshCw size={12} className="text-metal-gold" /> MODIFICACIONES
                        </h4>
                    ...
                    <div className="p-4 rounded-lg bg-metal-gold/5 border border-white/5 hover:border-metal-gold/30 transition-all">
                        <h4 className="text-white font-bold flex items-center gap-2 text-xs mb-2">
                            <UserX size={12} className="text-metal-gold" /> TERMINACIÓN
                        </h4>
                        <p className="text-[10px] leading-relaxed">
                    ...
                    <div className="p-4 rounded-lg bg-metal-gold/5 border border-white/5 hover:border-metal-gold/30 transition-all">
                        <h4 className="text-white font-bold flex items-center gap-2 text-xs mb-2">
                            <Lock size={12} className="text-metal-gold" /> SEGURIDAD
                        </h4>
                        <p className="text-[10px] leading-relaxed">
            ...
            <section className="space-y-4">
                ...
                <div className="p-5 bg-black/40 border border-white/5 rounded-xl space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs leading-relaxed">
                            Únicamente procederá la reversión del pago en los casos estrictamente señalados por la Ley (fraude, operación no solicitada o producto no recibido). Para solicitar una reversión por estos motivos, el Usuario deberá notificarlo dentro de los cinco (5) días hábiles siguientes al conocimiento de la operación fraudulenta al correo <a href="mailto:docenciainformatica2025@gmail.com" className="text-metal-gold hover:underline">docenciainformatica2025@gmail.com</a>.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="space-y-4">
                <h2 className="text-lg md:text-xl font-bold text-white flex items-center gap-3">
                    <Gavel className="text-metal-gold" />
                    7. LEY APLICABLE
                </h2>
                <p className="leading-relaxed text-sm">
