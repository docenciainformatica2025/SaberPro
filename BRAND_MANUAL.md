...
### 1.3 Valores
- **Excelencia:** No aceptamos lo "suficientemente bueno". Buscamos lo excepcional.
- **Claridad:** Diseño limpio, sin ruido, enfocado en el aprendizaje.
- **Sofisticación:** Tratamos al estudiante como el profesional que está a punto de ser.
- **Innovación:** Tecnología de punta al servicio de la educación.
...
### 2.1 Logotipo
El logotipo se compone de un isotipo (letra "S" estilizada) y el logotipo textual.

- **Isotipo:** Una "S" negra contenida en un cuadrado con bordes redondeados (`rounded-xl`) y un fondo degradado de **Metal Gold** a un tono ámbar oscuro.
- **Logotipo Textual:** "Saber" en blanco (White) y "Pro" seguido del año (ej. "2026") en **Metal Gold**.
- **Fuente del Logo:** Geist Sans (Bold / Black), con tracking ajustado (`tracking-tight`).
