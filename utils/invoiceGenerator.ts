...
const LOGO_SVG = `<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M50 5 L89 27.5 V72.5 L50 95 L11 72.5 V27.5 L50 5Z" fill="#121212"/>
    <path d="M50 5 V95" stroke="white" stroke-width="0.5" stroke-opacity="0.2" />
    <path d="M11 27.5 L89 27.5" stroke="white" stroke-width="0.5" stroke-opacity="0.2" />
    <path d="M11 72.5 L89 72.5" stroke="white" stroke-width="0.5" stroke-opacity="0.2" />
    <path d="M35 35 Q 50 20, 65 35 C 80 50, 20 50, 35 65 Q 50 80, 65 65" stroke="#F1F0E8" stroke-width="8" stroke-linecap="round" fill="none"/>
</svg>`;
